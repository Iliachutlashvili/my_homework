...
# დავალება გავაკეთე და ინფუთები მივამატე უბრალოდ მაინტერესებდა თუ იმუშავებდა. ინფუთებს თუ მოვხსით 50,51,52,53 ლეინებში
# num1 და num2 ების ნაცვლად ჩვწერდი ციფრებს ჰარდად და გამოიტანდა მხოლოდ იმ რიცხვების ნამრავლს/მიმატებას და ა.შ. 